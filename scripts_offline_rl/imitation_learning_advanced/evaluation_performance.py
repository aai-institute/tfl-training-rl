...
import gym
import torch
from ToBeDeleted.transformer_model import DecisionTransformer, evaluate_on_env
...
path_to_model = "../model/model_d4rl_halfcheetah_medium_v0_20000iters.pt"
...
eval_rtg_target = 4000
eval_rtg_scale = 1000		# normalize returns to go
num_test_eval_ep = 300			# num of evaluation episodes
