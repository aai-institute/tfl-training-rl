# -*- coding: utf-8 -*-
#
# tfl-training-rl documentation build configuration file
#
...
def linkcode_resolve(domain, info):
    link_prefix = "https://github.com/aai-institute/tfl-training-rl/blob/master"
    if domain != "py":
        return None
    if not info["module"]:
        return None
...
htmlhelp_basename = "tfl-training-rl_doc"
